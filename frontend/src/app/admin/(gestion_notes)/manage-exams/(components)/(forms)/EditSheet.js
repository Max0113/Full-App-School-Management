...
import { Connect_Exams, Connect_Lookups } from "@/components/Api/admin/SchoolLife";
...
export function EditSheet({ exam, open, onOpenChange, refresh, setrefresh , selectedClasse}) {
