...
function page() {
  return (
    <main className="px-10 py-5">
      <div className="mb-4">
        <h1 className="text-3xl font-bold py-1 mb-0">Controller Students 👨‍🎓</h1>
        <p className="font-light text-white/20">
          tu peux update et create , delete tout student{" "}
        </p>
      </div>
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className={"px-3 py-6 mb-3 space-x-3"} variant="line">
          <TabsTrigger value="parents">Students</TabsTrigger>
